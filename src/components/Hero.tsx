      ...
      <Container className="relative grid gap-14 py-20 lg:grid-cols-[1.15fr_.85fr] lg:items-center">
        ...
        >
          ...
          <img
            ...
            loading="eager"
          />
          <div className="absolute -left-5 top-14 rounded-2xl border border-white/10 bg-black/50 p-4 shadow-2xl backdrop-blur-xl">
            <div className="text-xs text-white/70">FOCUS</div>
            <div className="mt-1 font-display font-semibold">
              Intelligent Systems
            </div>
          </div>
          <div className="absolute -right-5 bottom-14 rounded-2xl border border-white/10 bg-black/50 p-4 shadow-2xl backdrop-blur-xl">
